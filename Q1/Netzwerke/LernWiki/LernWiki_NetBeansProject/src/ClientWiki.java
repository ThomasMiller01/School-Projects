    ...
    public void processMessage(String pMessage){
        ...
        if(pMessage.contains("connection")){
            ...
            if(pMessage.contains("needed")){
                ...
                System.out.println("[Client] Type 'cmd' to see all possible commands");
            }
            else if(pMessage.contains("false")){
                System.out.println("[Client] Wrong username ...");
            }
        }
        else if(pMessage.contains("logged out")){
            System.out.println("[Client] Verbindung zum Server wurde geschlossen ...");            
        }
        else if(pMessage.contains("wiki")){
            if(pMessage.contains("wikiall")){
