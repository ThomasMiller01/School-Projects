...
public class ServerWiki extends Server {
    ...
    public void fillDict(boolean debug){
//        wiki.put("Wort", "Ein Wort ist ein Wort");
//        wiki.put("Baum", "Baum ist Holz");
//        wiki.put("Wassermelone", "Malte sehr intelligent ... nicht");        
        WordDatabase wordDatabase = new WordDatabase(debug); 
        wiki = wordDatabase.loadWords(debug);
    }
